...
class Img2Graph(LightningModule):
    def __init__(self,
    ...
    def forward(self, img, graph, past_key_values=None, img_hidden_cache=None):
        ...
        decoder_mask = get_extended_attention_mask(attention_mask=graph['attention_mask'], use_causal=True)
    ...
    def training_step(self, batch, batch_idx):
        img, graph, target = batch
        logits, _, _ = self.forward(img, graph)
